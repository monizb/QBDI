...
struct TestInst TestInsts[MNEM_COUNT] = {
    {3, 2, true, QBDI::REGISTER_WRITE, {
           ...
           {QBDI::OPERAND_IMM, QBDI::OPERANDFLAG_NONE, MNEM_IMM_SHORT_VAL, 1, 0, -1, NULL, QBDI::REGISTER_UNUSED},
        }
    },
    ...
    {5, 2, true, QBDI::REGISTER_WRITE, {
           {QBDI::OPERAND_IMM, QBDI::OPERANDFLAG_NONE, MNEM_IMM_VAL, 4, 0, -1, NULL, QBDI::REGISTER_UNUSED},
...
struct TestInst TestInsts[MNEM_COUNT] = {
    {4, 3, true, {
            ...
            {QBDI::OPERAND_IMM, MNEM_IMM_SHORT_VAL, sizeof(QBDI::rword), 0, -1, NULL, QBDI::REGISTER_UNUSED},
